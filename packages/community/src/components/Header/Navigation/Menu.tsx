...
function Menu({ menuName, menuItems }: Props) {
  return (
    <li className="group text-white h-full md:h-auto">
      <div
      ...
      {menuItems && (
        <div className="absolute left-0 md:left-auto w-full md:w-auto top-full max-h-0 group-hover:max-h-[400px] bg-[#fDEED5] md:bg-[#FAD55F] z-10 text-[#05070E] md:text-white overflow-hidden transition-all duration-300 ease-in-out shadow-[0_1px_5px_0_rgba(0,0,0,0.15)]">
