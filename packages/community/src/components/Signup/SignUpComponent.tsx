      ...
      {!isTermAgree ? (
        <>
          <div className="div-agreement">
            <h3>가입안내</h3>
            <p>
              안녕하세요? 서울대학교 아마추어 천문회 - AAA - 의 홈페이지에
              오신것을 환영합니다!
              <br />
              <br />
              지금 가입하려고 하는 사이트는 AAA 회원들이 온라인활동을 하는
              공간으로, 회원들의 개인정보 보호와 원활한 커뮤니티 활동을 위하여
              몇가지 지켜주셔야 할 사항들이 있습니다.
              <br />
              <br />
              귀찮으시더라도 아래 주의사항을 잘 읽어주시고 가입하여 주시기
              바랍니다.
              <br />
              <br />
              <br />
              ...
              <br />
              <br />
              따라서 실명으로 가입하지 않으시는 회원님은 강제 탈퇴조치 될 수
              있으니, 주의하시기 바랍니다.
              <br />
              <br />
              <br />
              ...
              <br />
              <br />
              회원들의 개인정보를 보호하고 자유로운 커뮤니티 활동을 보장하기
              위하여 소정의 자격요건을 만족하시지 못하는 분들은 몇몇 기능을
              사용하실 수 없습니다.
              <br />
              <br />
              <br />
              ...
              <br />
              9(명왕성): 비회원. 동아리원들의 커뮤니티를 위한 부분을 제외하고
              이용 가능.
              <br />
              <br />
              AAA 회원임을 확인하기 위하여 가입번호를 인증 수단으로 사용합니다.
              가입번호는 정확한 번호를 체크하는 것이 아니라 양식만 확인합니다.
              정확한 양식으로 제출시 8등급으로 가입처리가 됩니다.
              <br />
              <br />
              다만, AAA의 회원은 아니나 AAA와 관련이 있는 분인 경우에는, 9등급
              회원으로 가입하여 손님방 게시판을 사용하실 수 있습니다.
              <br />
              <br />
              그리고, AAA 회원이지만 가입번호 양식을 모르시는 분들 역시, 가입
              후에 손님방 게시판에 문의글을 올려 주시면 확인 후 등급을
              조절해드리겠습니다.
              <br />
              <br />
              3. 회원 가입 시에는 학번과 학과, 전화번호를 필히 입력하여
              주십시오. 신원 확인을 위한 것이니 필히 입력해주시기 바랍니다.
              미입력시에는 9등급으로 강제 조정됩니다.
              <br />
              <br />
          ...
          <div className="signup-input-wrapper">
            ...
            <button
              className="enif-btn-common-rec signup-btn"
              onClick={setIsAgree}
            >
              가입안내문에 동의
            </button>
        ...
        <div className="signup-input-wrapper">
          <InputField
            ...
            handleBlur={checkDupId}
            required={true}
            valid={userInfo.id.valid}
            value={userInfo.id.value}
            invalidMessage={
              dupId ? '이미 사용중인 ID입니다' : '4-12자리의 영문 혹은 숫자'
            }
          />
          <InputField
            label="비밀번호*"
          ...
          <InputField
            ...
            handleChange={handleChange}
            required={true}
            valid={userInfo.passwordCf.valid}
            value={userInfo.passwordCf.value}
          ...
          <InputField
            ...
            name="aaaNum"
            handleChange={handleChange}
            valid={userInfo.aaaNum.valid}
            value={userInfo.aaaNum.value}
          ...
          <InputField
            ...
            name="schoolNum"
            handleChange={handleChange}
            valid={userInfo.schoolNum.valid}
            value={userInfo.schoolNum.value}
