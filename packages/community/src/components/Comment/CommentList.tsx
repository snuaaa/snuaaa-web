...
const CommentList = ({
                    ...
                    <div className="actions-wrapper">
                      <div className="edit-wrapper">
                        <i
                          ...
                          onClick={() =>
                            setCommentInEdit(comment.comment_id, comment.text)
                          }
                        ></i>
                      </div>
                  ...
                  {comment.comment_id === commentInEdit ? (
                    <>
                      <textarea
                        ...
                        onChange={editingContentsChange}
                      ></textarea>
  ...
  return (
    <div className="comment-list-wrapper">{makeCommentList(comments)}</div>
  );
};
