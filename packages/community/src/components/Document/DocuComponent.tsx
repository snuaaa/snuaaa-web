    ...
    <div className="post-wrapper">
      <div className="post-title">
        ...
        {my_id === userInfo.user_id && (
          <ActionDrawer clickEdit={setEditState} clickDelete={deleteDoc} />
        )}
      </div>
      <div className="post-info-other">
        <div className="post-author">{userInfo.nickname}</div>
        <div className="post-date">
          {convertFullDate(contentInfo.createdAt)}
        </div>
      </div>
      <div className="post-content">
        <div className="doc-text-wrp">{breakLine(contentInfo.text)}</div>
      </div>
      <div className="file-download-wrapper">{makeFileList()}</div>
