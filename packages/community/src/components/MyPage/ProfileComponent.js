    ...
    <>
      <div className="profile-wrapper">
        ...
        <InputField
          ...
          handleChange={handleChange}
          maxLength={30}
          valid={emailInfo.valid}
          invalidMessage="이메일 형식에 맞게 입력해주세요"
        />
        <InputField
          label="Mobile*"
          name="mobile"
          value={mobileInfo.value}
          valid={mobileInfo.valid}
          handleChange={handleChange}
        ...
        <InputField
          label="동아리번호"
          name="aaa_no"
          value={aaaNumInfo.value}
          valid={aaaNumInfo.valid}
          handleChange={handleChange}
        ...
        <InputField
          label="학번"
          name="col_no"
          value={colNumInfo.value}
          valid={colNumInfo.valid}
          handleChange={handleChange}
        ...
        <InputField
          label="전공"
          name="major"
          value={majorInfo.value}
          valid={majorInfo.valid}
          handleChange={handleChange}
        />
        ...
        <div className="enif-input-field">
          ...
          <textarea
            name="introduction"
            value={introInfo.value}
            onChange={(e) => handleChange(e)}
          />
        </div>
        <div className="btn-wrapper">
          <button className="btn-withdraw" onClick={() => deleteUser()}>
            탈퇴하기
          </button>
          <button
            className="btn-save"
